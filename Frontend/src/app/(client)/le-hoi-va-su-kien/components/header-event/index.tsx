				...
				<div className="w-full h-full mt-20 flex flex-col items-center justify-center text-center px-4 z-20">
					...
					<div className="min-h-[100px] sm:min-h-[120px] flex items-center">
						<BoxReveal boxColor="#ffffff" duration={0.8} width="fit-content" className='h-full'>
							...
							>
								Trang Tin Tức & Sự Kiện Tỉnh Tây Ninh
							</h1>
						</BoxReveal>
					</div>
					...
					<BoxReveal boxColor="#ffffff" duration={0.9} width="fit-content">
						<p className="text-lg sm:text-xl md:text-2xl text-white font-semibold mt-4 drop-shadow-md animate-fadeIn tracking-wide">
					...
					<BoxReveal boxColor="#ffcc00" duration={1.0} width="fit-content">
						<ShinyButton
							...
							className="mt-6 px-6 sm:px-8 py-3 sm:py-4 bg-[#ffcc00] text-[#2e6fb8] font-bold rounded-lg shadow-xl hover:bg-[#e6b800] hover:shadow-2xl transition-all duration-300 transform hover:scale-105 sm:mt-8"
						>
							<p>Xem Các Sự Kiện Nổi Bật</p>
						</ShinyButton>
					</BoxReveal>
				</div>
			</div >
