		...
		<form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
			...
			<div className="space-y-2">
				<div className="flex items-center justify-between">
					...
					<button type="button" onClick={onForgotPassword} className="text-sm text-sky-500 hover:underline">
						Quên mật khẩu?
					</button>
				</div>
				<div className="relative">
			...
			<div className="mt-8 text-center">
				<p className="text-gray-600">
					Chưa có tài khoản?{" "}
					<button type="button" onClick={onSwitchMode} className="font-medium text-sky-500 hover:underline">
						Đăng ký ngay
					</button>
				</p>
			</div>
