						...
						<Tooltip>
							<TooltipTrigger asChild>
								<DropdownMenuTrigger asChild>
									<button className="p-2 rounded-md hover:bg-muted transition flex items-center gap-1">
					...
					<Tooltip>
						<TooltipTrigger asChild>
							<button
								...
								className={`p-2 rounded-md hover:bg-muted transition ${editor.isActive("horizontalRule")
					...
					{[
						...
						<Tooltip key={idx}>
							<TooltipTrigger asChild>
								<button
									onClick={btn.action}
									className={`p-2 rounded-md hover:bg-muted transition ${btn.pressed ? "bg-muted text-primary" : ""
										}`}
								>
									{btn.icon}
								</button>
