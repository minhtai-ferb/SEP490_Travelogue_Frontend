        ...
        <div className="space-y-6">
          ...
          {!manualMode && (
            <div className="space-y-2">
              ...
              <p className="text-xs text-gray-500 flex items-center gap-1">
                <span>💡</span>
                Nhập ít nhất 2 ký tự để bắt đầu tìm kiếm và chọn từ danh sách
                gợi ý
              </p>
            </div>
          )}
          ...
          <div className="text-xs text-gray-500 bg-gray-50 rounded-lg p-4 space-y-2">
            ...
            <ul className="list-disc list-inside space-y-1 ml-6">
              <li>
                <strong>Tìm kiếm thông minh:</strong> Nhập địa chỉ để xem gợi ý
                từ VietMap API
              </li>
              <li>
              ...
              <li>
                <strong>Nhập thủ công:</strong> Bật chế độ thủ công để nhập tọa
                độ hoặc click trên bản đồ
              </li>
              <li>
