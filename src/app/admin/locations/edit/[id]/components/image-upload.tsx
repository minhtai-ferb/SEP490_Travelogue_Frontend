      ...
      <CardContent className="space-y-4">
        ...
        <AntUpload.Dragger {...uploadProps} disabled={uploading || isLoading}>
          <div className="flex flex-col items-center justify-center py-8">
            ...
            <p className="text-lg font-medium">
              {uploading ? "Đang tải lên..." : "Kéo thả hoặc click để tải lên hình ảnh"}
            </p>
            <p className="text-sm text-muted-foreground mt-2">Hỗ trợ: JPG, PNG, GIF (tối đa 10MB mỗi file)</p>
          </div>
        </AntUpload.Dragger>
        ...
        {mediaDtos.length > 0 && (
          <div className="text-sm text-muted-foreground flex justify-between">
            ...
            {hasThumbnail && <p className="text-primary">✓ Đã chọn ảnh đại diện</p>}
          </div>
        )}
      </CardContent>
    </Card>
