            ...
            <div className="flex gap-2">
              <Button
                ...
                {...(user?.roles?.includes("Admin") && {
                  onClick: () => router.push("/admin/booking/tour-schedule"),
                })}
                {...(user?.roles?.includes("Moderator") && {
                  onClick: () => router.push("/moderator/booking/tour-schedule"),
                })}
              >
                Xem Tất Cả
              </Button>
          ...
          <CardContent className="space-y-4">
            <div className="flex gap-2">
              <Button
                className="flex-1 bg-black hover:bg-gray-800"
                {...(user?.roles?.includes("Admin") && {
                  onClick: () => router.push("/admin/booking/tour-guide"),
                })}
                {...(user?.roles?.includes("Moderator") && {
                  onClick: () => router.push("/moderator/booking/tour-guide"),
                })}
              >
                Xem Tất Cả
              </Button>
          ...
          <CardContent className="space-y-4">
            <div className="flex gap-2">
              <Button
                className="flex-1 bg-black hover:bg-gray-800"
                {...(user?.roles?.includes("Admin") && {
                  onClick: () => router.push("/admin/booking/workshop"),
                })}
                {...(user?.roles?.includes("Moderator") && {
                  onClick: () => router.push("/moderator/booking/workshop"),
                })}
              >
                Xem Tất Cả
              </Button>
