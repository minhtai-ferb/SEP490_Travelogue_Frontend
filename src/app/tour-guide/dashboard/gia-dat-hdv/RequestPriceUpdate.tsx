...
function RequestPriceUpdate() {
	...
	const handleJumpToPage = () => {
		...
		if (pageNum >= 1 && pageNum <= totalPages) {
			...
			toast.error(`Trang phải từ 1 đến ${totalPages}`);
		}
	};
								...
								<div className="space-y-4 mt-4">
									...
									<div className="space-y-2">
										...
										<div className="relative">
											<CiMoneyBill className="absolute left-3 top-3 h-4 w-4 text-gray-400" />
											<Input
												id="price"
												type="number"
						...
						<CardContent className="p-6">
							<div className="flex items-center justify-between">
								...
								<div className="bg-blue-100 p-3 rounded-full">
									<CiMoneyBill className="h-6 w-6 text-blue-600" />
								</div>
							</div>
						</CardContent>
					</Card>
							...
							<div className="space-y-4 mt-6">
								...
								<div className="flex flex-col lg:flex-row items-start lg:items-center justify-between gap-4">
									...
									<div className="flex flex-col sm:flex-row items-start sm:items-center gap-4">
										<div className="flex items-center gap-2">
											<Label htmlFor="pageSize" className="text-sm whitespace-nowrap">Hiển thị:</Label>
									...
									<div className="flex items-center gap-2">
										<Label htmlFor="jumpPage" className="text-sm whitespace-nowrap">Đi đến trang:</Label>
										<Input
											id="jumpPage"
											type="number"
											placeholder="1"
