...
const ScheduleTourguideCL = () => {
	const [month, setMonth] = useState<Date>(new Date())
	const monthLabel = month.toLocaleDateString("vi-VN", { month: "long", year: "numeric" })

	const { getTourGuideSchedule, getTourGuideScheduleDetail } = useTourguideAssign()
	...
	const onSelectEvent = useCallback(async (e: any) => {
		try {
			const res = await getTourGuideScheduleDetail(e.resource.id)
			setSelected(res as any)
			setDetailOpen(true)
		} catch (error) {
...
export default ScheduleTourguideCL
